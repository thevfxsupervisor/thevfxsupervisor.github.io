...
eyebrow: Experiment
h1: The tracker already knows what is in every shot. So SignalBox builds them.
...
SignalBox generates shots from what the tracker already knows, and the results publish themselves as Versions, ready in the usual review process. Nobody learns a new tool.
...
SignalBox also tracks dependencies. Revise an upstream asset or a keyframe panel, and every shot downstream of it regenerates instead of quietly going stale.
